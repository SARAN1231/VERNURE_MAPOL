                  ...
                  <div className="web_development_technologies row justify-content-center">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_javascript.svg"
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/case/icon_elephent.svg"
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_swift.svg"
                            alt="Swift SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_typescript.svg"
                            alt="Typescript SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/case/icon_python.svg"
                            alt="Python SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_g318.svg"
                            alt="G318 SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_java.svg"
                            alt="Java SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_ruby.svg"
                            alt="Ruby SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_c_plus.svg"
                            alt="C++ SVG Icon"
                          />
                        </div>
                        <div className="iconbox_content">
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_react_js.svg"
                    ...
                    <div className="col-lg-2 col-md-3 col-sm-4 col-6">
                      <div className="iconbox_block text-center p-0 shadow-none bg-transparent">
                        <div className="iconbox_icon">
                          <img
                            src="./images/icons/icon_laravel.svg"
