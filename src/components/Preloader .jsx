...
import siteLogo from "../assets/images/site_logo/site_logo_2.svg"; // Adjust the path based on your project structure
// Import Swiper if you use Swiper functionality

import "../assets/css/fontawesome.css";
import "../assets/css/style.css";

import "../../node_modules/react-circular-progressbar/dist/index.esm";
const Preloader = () => {
  useEffect(() => {
    // Add your custom jQuery and JavaScript code here
    (function ($) {
      "use strict";
