 ...
 useEffect(() => {
  ...
  return (
    <>
      {/* <Preloader /> */}
      <header
        className={color ? "site_header site_header_2 header-bg":"site_header site_header_2"}
        style={{
          position: "fixed",
          color: "white",
          height: "100px",
            ...
            <div className="row align-items-center">
              <div className="col-lg-3 col-5">
                <div className="site_logo">
                  <Link to={"/"}>
                    <img
                      src={color ? "./images/Mapol/mapol-logo-lg.png" : "./images/site_logo/site_logo_2.svg"}
                      alt="Mapol Logo"
                      style={{
                        width: "200px",
                        height: "80px",
